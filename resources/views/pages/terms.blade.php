...
@section('title', __('messages.terms_of_service') . ' - besttik.com')
@section('description', 'Terms of Service for besttik.com. Read our terms and conditions for using our video parsing service.')
...
<div class="prose prose-lg max-w-none">
    ...
    <div class="bg-gray-50 rounded-2xl p-6">
        <p class="text-gray-800 font-medium mb-2">besttik.comLegal Team</p>
