...
@section('title', '小红书视频解析 - 小红书视频下载 - 免费小红书去水印工具')
@section('description', '专业的小红书视频解析工具，支持小红书视频下载、小红书图片下载、小红书去水印。免费在线解析小红书内容，高清无水印下载。')
@section('keywords', '小红书视频解析,小红书视频下载,小红书去水印,小红书图片下载,小红书解析工具,小红书无水印下载')

@section('content')
<section class="relative overflow-hidden bg-gradient-to-br from-pink-50 via-white to-red-50 min-h-screen flex items-start justify-center pt-40">
    <div class="absolute inset-0 bg-grid-pattern opacity-5"></div>
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                <span class="bg-gradient-to-r from-pink-600 to-red-600 bg-clip-text text-transparent">小红书视频解析</span>
            </h1>
            <h2 class="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
                专业的小红书内容解析工具，支持小红书视频下载、图片保存、去水印处理
            </h2>
                ...
                <form id="videoParseForm" class="relative">
                    ...
                    <div class="relative group input-container">
                        ...
                        <div class="absolute right-2 top-2 bottom-2 flex items-center gap-2">
                            ...
                            <button type="submit" class="parse-button bg-pink-600 hover:bg-pink-700 text-white transition-all duration-200 flex items-center justify-center cursor-pointer shadow-md hover:shadow-lg ui-text rounded-md px-3 py-2 flex-shrink-0">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                                </svg>
                                <span class="hidden sm:inline text-xs lg:text-sm font-medium ml-1 whitespace-nowrap">解析小红书</span>
                            </button>
                        </div>
                    </div>
                </form>
            ...
            <div id="loadingState" class="hidden max-w-3xl mx-auto mb-8">
                <div class="bg-white border border-gray-100 rounded-2xl p-8 text-center shadow-xl">
                    ...
                    <p class="text-gray-600 font-medium text-lg body-regular">正在解析小红书内容...</p>
                </div>
            </div>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl lg:text-4xl text-gray-900 mb-4">小红书解析特色功能</h2>
            <p class="text-lg text-gray-600">专业的小红书内容下载服务</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            <div class="text-center group">
                ...
                <h3 class="text-xl text-gray-900 mb-4">视频无水印下载</h3>
                <p class="text-gray-600 leading-relaxed">自动去除小红书视频水印，获得高清无水印视频文件</p>
            </div>
            ...
            <div class="text-center group">
                ...
                <h3 class="text-xl text-gray-900 mb-4">图片批量保存</h3>
                <p class="text-gray-600 leading-relaxed">支持小红书图片批量下载，保持原始高清画质</p>
            </div>
            ...
            <div class="text-center group">
                ...
                <h3 class="text-xl text-gray-900 mb-4">快速在线解析</h3>
                <p class="text-gray-600 leading-relaxed">无需下载软件，在线即可完成小红书内容解析</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl lg:text-4xl text-gray-900 mb-4">小红书解析使用教程</h2>
            <p class="text-lg text-gray-600">简单4步完成小红书内容下载</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">复制小红书链接</h3>
                <p class="text-gray-600 text-sm">在小红书APP中找到要下载的内容，点击分享按钮复制链接</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">将复制的小红书链接粘贴到上方的解析输入框中</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">点击"解析小红书"按钮，系统自动分析内容</p>
            </div>
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">下载保存</h3>
                <p class="text-gray-600 text-sm">选择需要的内容格式，点击下载按钮保存到本地</p>
            </div>
        </div>
    </div>
</section>
