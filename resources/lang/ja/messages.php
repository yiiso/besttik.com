...
return [
    ...
    // Footer
    'footer_description' => 'プロフェッショナルなグローバル動画解析ツール、複数プラットフォームの動画リンク解析とダウンロードをサポート。',
    'navigation' => 'ナビゲーション',
    'products' => '製品',
    'support' => 'サポート',
    ...
    'register_failed' => '登録に失敗しました。再試行してください',
    ...
    'page_not_found_message' => '申し訳ございませんが、お探しのページが見つかりませんでした。移動、削除された可能性があるか、間違ったURLを入力された可能性があります。',
    'back_to_home' => 'ホームに戻る',
    'get_help' => 'ヘルプを取得',
    'popular_pages' => '人気ページ',
